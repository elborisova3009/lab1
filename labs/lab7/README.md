...
SPT блокирует порт F0/4 на коммутаторе S1, у которого самый высокий идентификатором BID.  
...
Уменьшу согласно задания стоимость этого порта корневого моста до 18, выполнив команду spanning-tree cost 18 режима конфигурации интерфейса.
