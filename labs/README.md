...
### 	Таблица адресации
![alt text](https://github.com/elborisova3009/otus-networks/blob/master/labs/Screenshot_06.09.2022(10-38-32).png)
### 	Задачи 
...
b. Проверим параметры VLAN 1 (VLAN 77 в моем случае).
