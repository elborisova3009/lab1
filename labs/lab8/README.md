...
Настрою на R1 и проверю сервер DHCPv4, который будет обслуживать две подсети: подсеть A и подсеть C.    
Шаг 1.	Настрою R1 с пулами DHCPv4 для двух поддерживаемых подсетей.   
Алгоритм на примере подсети A следующий:   
